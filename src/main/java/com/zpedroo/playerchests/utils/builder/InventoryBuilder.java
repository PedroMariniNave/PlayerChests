...
import static com.zpedroo.playerchests.utils.builder.InventoryUtils.*;
...
public class InventoryBuilder {
    ...
    public InventoryBuilder(Inventory inventory) {
        this(inventory.getTitle(), inventory.getSize());
    }

    public InventoryBuilder(Inventory inventory, ItemStack previousPageItem, int previousPageSlot, ItemStack nextPageItem, int nextPageSlot) {
        this(inventory.getTitle(), inventory.getSize(), previousPageItem, previousPageSlot, nextPageItem, nextPageSlot);
    }
